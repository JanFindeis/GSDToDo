...
- [x] **Phase 1: Core CLI** - Implement add, list, and done commands with JSON persistence (completed 2026-08-25)
...
- [x] 01-01-PLAN.md — Walking Skeleton: package.json + todo.js with cmdAdd, loadTodos, saveTodos wired end-to-end
- [x] 01-02-PLAN.md — Expansion: cmdList with Unicode strikethrough + cmdDone command
...
|-------|----------------|--------|-----------|
| 1. Core CLI | 2/2 | Complete    | 2026-08-25 |
